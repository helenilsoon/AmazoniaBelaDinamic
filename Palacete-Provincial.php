...
<section class="container-pagDois">
	<article class="box-pagDois">
		<ol>
			...
			<li><a href="?=pPalacete-Provincial">Palacete Provincial</a></li> <!-- Editar aqui--> 
		</ol>
		<h1>Palacete Provincial</h1><!-- Editar aqui-->
		...
		<div class="pagDois-boxImg">
			...
			<figure class="galeria-img">
				<img  src="img/Cigs/zoologico-do-CIGS-manaus-zarpo.jpg" alt="teatro 1"  style="width:100%"><!-- Editar aqui-->
				<legend> Teatro amazonas 1</legend>
				<span class="credito">creditos: Elias moraes</span>
			</figure>
			<figure class="galeria-img">
				<img   src="img/Cigs/Cigs.jpg" style="width:100%"><!-- Editar aqui-->
